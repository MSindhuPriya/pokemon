...
-   `model` contains fitted Bayesian models
...
The abstract, introduction, and some code for models were written with the help of ChatGPT and the entire chat history is available in inputs/llms/usage.txt. 
